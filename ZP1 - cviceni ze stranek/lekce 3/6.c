...
/* 6. Ze vstupu naètìte délky stran trojúhelníka. Rozhodnìte, jestli se trojúhelník s danými
delkami stran existuje. Pokud ano, rozhodnìte, jestli je pravoúhlý, rovnostranný nebo
obyèejný. */
